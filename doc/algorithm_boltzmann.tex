...
\node[block, text=blue, below=2cm of repayments] (ir) {
...
\node[statistics, below=0cm of repayments_stats2,xshift=0.5cm] (repayments_stats3) {
  bankruptcies \\
  bankruptcy\_rationed };

\node[statistics, below=0cm of repayments_stats1] (repayments_stats4) {
  fitness \\
  policy };
...
\node[statistics, below=0.5cm of ir_stats] (repayments_stats4) {
  prob\_bankruptcy \\
  c num\_banks maxE };
