...
\begin{itemize}
    ...
    \item \textbf{equity}: Sum of equity $E$ of all banks: $L + C + R = D + E$
    \item \textbf{equity\_lenders}: Average $E$ of banks who are lenders
    ...
    \item \textbf{num\_loans}:  Num of loans in this step. Both global and \textbf{stats\_market} will be the same
    ...
    \item \textbf{psi}: Power market ($psi$) of the banks who are lenders, value $[0..1]$
