...
\begin{itemize}
    ...
    \item \texttt{interbank.py --save result --output_format csv --log DEBUG --logfile result.txt}: Save the results in \texttt{result.csv} in $CSV$ and the detailed log in \texttt{result.txt}.
