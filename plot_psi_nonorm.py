...
eje_y = ['1_psi0_nonorm', '1_psi025_nonorm', '1_psi05_nonorm', '1_psi075_nonorm', '1_psi1_nonorm', '3_psiendog_nonorm']
titles_y  = ['psi=0','psi=0.25','psi=0.5','psi=0.75','psi=0.99','psi endogenous' ]
resultado = 'psi_p_nonorm.png'
titulo = 'comparing psi/p'

ejes_max = [[600,650],[7,11],[-100,+100]]
# valores para p
...
for i, itemi in enumerate(eje_y):
    ...
    for j, itemj in enumerate(eje_x):
        ...
        axes[i, j].set_ylim(ejes_max[j][0], ejes_max[j][1])
