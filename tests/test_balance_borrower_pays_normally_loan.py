...
class BalanceTestCase(tests.interbank_testclass.InterbankTest):
    ...
    def test_values_after_execution(self):
        self.assertBank(bank=self.model.banks[0], C=16.13007907703858, L=15.0, D=22.0, E=9.57007907703858,
                        paid_loan=3.040000000000001, paid_profits=0.42992092296142104)
        ...
        self.assertBank(bank=self.model.banks[1], C=22.439999999999998, L=14.333333333333323, D=8.0,
                        E=9.963254256294746, s=22.439999999999998)
