...
class ValuesAfterExecutionTestCase(unittest.TestCase):
    ...
    def test_values_after_execution(self):
        ...
        self.assertEqual(self.model.banks[1].C,  34.98532086867645)
        self.assertEqual(self.model.banks[3].D, 158.5177171601113)
        self.assertEqual(self.model.banks[4].E, 9.429456399322575)
        self.assertEqual(self.model.banks[0].A, 356.2984613650349)
        self.assertEqual(self.model.banks[0].R, 7.0587437697151705)
        self.assertEqual(self.model.banks[1].A, 157.84216415171068)
        self.assertEqual(self.model.banks[2].A, 116.680304507896)
        self.assertEqual(self.model.banks[3].A, 173.5177171601113)
        self.assertEqual(self.model.banks[4].A, 139.39210346087305)
        self.assertEqual(self.model.banks[4].R, 2.6390596277063962)
