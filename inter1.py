        ...
        for attribute in configuration:
            if attribute.startswith('):
                ...
                if attribute == ':
                    ...
                    self.config.lender_change.set_parameter(attribute, configuration["" + attribute])
...
class Utils:
    ...
    def run_interactive():
        ...
        parser.add_argument("--, type=str, default="default", help="Bank lender's change method (?=list)")
        ...
        model.config.lender_change = determine_algorithm(args.
        model.config.lender_change.set_parameter("p", args.p)
