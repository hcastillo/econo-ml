...
class MarketPowerRun(exp_runner_parametrized.ExperimentRunParametrized):
    ...
    OUTPUT_DIRECTORY = "/experiments/251105_ir_study_base_psi_asset_i"
    ...
    extra_individual_parameters = [
        {'asset_i_avg_ir': 16.75102},
        {'asset_i_avg_ir': 16.75329},
        {'asset_i_avg_ir': 16.78963},
        {'asset_i_avg_ir': 16.72195},
        {'asset_i_avg_ir': 16.81146},    ]
