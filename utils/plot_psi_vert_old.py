...
Plots:
 - Generate a table of axis_x x axis_y plots:
      ...
      rows are different values of psi
...
for i, item_i in enumerate(axis_y):
    ...
    if not os.path.isdir(input_dir + '\\' + item_i):
        break
    data, _  = Statistics.read_gdt(input_dir + '\\' + item_i + '\\results.gdt')
    yys = {}
